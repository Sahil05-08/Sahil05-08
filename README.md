...
i have build the annapurna ai ai agent assistant which is  use to generate the recipe base on ingrdients so add the skills which require where i have use groq llama model and also use gradio for frontend and chromadb to store the converzation
